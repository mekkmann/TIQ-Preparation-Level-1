namespace Mission2
{
    internal class Program
    {
        ...
        {
            //works
            var normal = new List<int>() { 1, 14, 7, 3, 12, 10, 15, 4, 2, 9, 11, 5, 8, 6, 13 };

            //works
            var duplicate = new List<int>() { 1, 14, 7, 14, 12, 1, 15, 4, 2, 9, 11, 5, 8, 6, 13 };

            //FIXED
            var negative = new List<int>() { 1, 14, -1, 3, 12, 10, 15, 4, 2, 9, 11, 5, 8, 6, 13 };

            //FIXED
            var extremeNegative = new List<int>() { 1, 14, 7, 3, 12, 10, 15, 4, 2, 9, -9001, 5, 8, 6, 13 };

            //works
            var extremePositive = new List<int>() { 1, 14, 7, 3, 12, 10, 1500, 4, 2, 9, 11, 5, 8, 6, 13 };

            //FIXED
            var emptyList = new List<int>();

            //FIXED
            var oneNumber = new List<int>() { 1 };

            //FIXED
            var onlyNegatives = new List<int>() { -1, -15, -13, -9 };


            var data = extremeNegative;
            // Insertion sort
            ...
            do
            {
                if (data.Count == 0)
                {
                    Console.WriteLine("No numbers to sort");
                    break;
                }
                if (data.Count == 1)
                {
